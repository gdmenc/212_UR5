...
--------------------
  ...
  - A receiver (cup, bowl, drain, ...) below POUR_TARGET_TASK. The
    target is the bottle OPENING's xyz, so set its z slightly above the
    receiver's rim, NOT at table height.
...
POUR_TARGET_TASK = np.array([-0.1, 0, 0.20])
"""xyz of the bottle's OPENING during the pour, in task frame. Set the z
3-5 cm above the receiver's rim so liquid falls cleanly. The bottle's
